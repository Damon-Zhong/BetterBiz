      ...
      <div className="container">
        <div className="content-section-heading text-center">
          ...
          <div className="container text-center my-auto">
            <div className="h2">BetterBiz is a platform where we showcase minority and undervalued business to others. </div> 
            <br />
            <div className="h3">
            With the global pandemic going, small businesses have taken one of the biggest toll, especially in Toronto. We wanted to  create a platform that not only helps people shop locally but also help communities that they support grow.
            <br /> 
            <br /> 
            For Our Customers   
            <br />
            <br />
             <ul>
                ...
                <li>Presented with details about each business, delivery, reviews,website links etc. </li>
                <li>Sign up and share their own experience with rating reviewing feature </li>
            </ul>
            <br /> 
            <br />
            ...
            <ul>
              ...
              <li>Reach out to the niche market of customers who are looking for way to support their community   </li>
              <li>Label their business and join a circle </li>
              <li>Submit their own business and assigned it to a category  </li>
             </ul> 
             <br />
             <br />
            </div> 
            <h3 className="text-secondary mb-0">Let’s work together and help make our community grow stronger.</h3>
